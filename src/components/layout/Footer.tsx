...
export function Footer() {
  return (
    <footer className="bg-slate-900 text-slate-300 dark:bg-background dark:border-t dark:text-muted-foreground pt-16 pb-8">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-slate-400 max-w-xs">
              Healthy Living Corporation cung cấp các sản phẩm chăm sóc sức khỏe cao cấp, 
              mang đến lối sống hiện đại và khỏe mạnh cho mọi gia đình.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><Link href="#benefits" className="hover:text-white transition-colors">Lợi Ích</Link></li>
              <li><Link href="#testimonials" className="hover:text-white transition-colors">Đánh Giá</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><Link href="#" className="hover:text-white transition-colors">Bảo Hành</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row items-center justify-between text-sm text-slate-500">
          ...
          <div className="flex gap-4 mt-4 md:mt-0">
            <span className="hover:text-white transition-colors cursor-pointer">VN</span>
            <span>|</span>
